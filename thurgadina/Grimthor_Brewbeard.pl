...
sub EVENT_SAY {
  ...
  if ($text =~/Hail/i) {
    quest::say("What do ye want? If you're after me frost oats I'll part ways with some for 100 platinum. Otherwise you'll have to rip them out of my cold dead hands!");
  }
...
sub EVENT_ITEM {
  ...
  {
	quest::say("Now get out of my face, outsider.");
	quest::summonitem($questt2);
  }
