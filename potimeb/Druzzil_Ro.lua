...
function event_timer(e)
	...
	elseif (e.timer == "druzzil5") then
		...
		eq.signal(223097,8);
		eq.depop();
		e.self:Emote("Congratulations! You basically beat the Addicted Dads server. You should feel pretty rad right now.");
	end
end
