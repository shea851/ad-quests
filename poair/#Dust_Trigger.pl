...
sub EVENT_TIMER 
{
	if($timer == 30) {
    		...
    		if (!defined(plugin::ReadQGlobal("dust_event_start")) && !defined(plugin::ReadQGlobal("dust_done")) && !$entity_list->IsMobSpawnedByNpcTypeID(215043) && !$entity_list->IsMobSpawnedByNpcTypeID(215044) && !$entity_list->IsMobSpawnedByNpcTypeID(215045) && !$entity_list->IsMobSpawnedByNpcTypeID(215060)) 
    		{
...
sub EVENT_SIGNAL 
{
	if ($signal == 1 && defined(plugin::ReadQGlobal("dust_event_start")) && !defined(plugin::ReadQGlobal("dust_done"))) 
	{
        	$counter+=1;
     	...
     	elsif ($signal == 2 && defined(plugin::ReadQGlobal("dust_event_start")) && !defined(plugin::ReadQGlobal("dust_done"))) 
     	{
		$counterone+=1;
     	...
     	elsif ($signal == 3 && defined(plugin::ReadQGlobal("dust_event_start")) && !defined(plugin::ReadQGlobal("dust_done"))) 
     	{
		quest::spawn2(215475,0,0,1671,527,356,192);
		quest::depop_withtimer(215046);
	}
     	elsif ($signal == 4  && !defined(plugin::ReadQGlobal("dust_done"))) 
     	{
     		quest::setglobal("dust_done",1,3,"F");
     	}
     	elsif ($signal == 5 && !defined(plugin::ReadQGlobal("dust_event_start")) && !defined(plugin::ReadQGlobal("dust_done"))) 
     	{
