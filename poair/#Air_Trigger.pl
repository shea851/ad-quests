...
sub EVENT_SIGNAL 
{	
	if ($signal == 1 && defined(plugin::ReadQGlobal("event_start")) && !defined(plugin::ReadQGlobal("wind_done")))
	{
        	$counter=0;
     	...
     	elsif ($signal == 2 && defined(plugin::ReadQGlobal("event_start")) && !defined(plugin::ReadQGlobal("wind_done"))) 
     	{
     		$counter+=1;
     	...
     	elsif ($signal == 3 && defined(plugin::ReadQGlobal("event_start")) && !defined(plugin::ReadQGlobal("wind_done"))) 
     	{
           	quest::depop_withtimer(215057);
     	   	quest::spawn2(215451,0,0,-1589.9,484.5,15.1,190.6);
     	}
     	elsif ($signal == 4 && !defined(plugin::ReadQGlobal("wind_done"))) 
	{
        	quest::setglobal("wind_done",1,3,"F");
     	}
	elsif ($signal == 5 && !defined(plugin::ReadQGlobal("event_start")) && !defined(plugin::ReadQGlobal("wind_done"))) 
	{	
